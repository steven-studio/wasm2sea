...
public:
    ...
    void handleF64Exp(BuildContext& bc, const Value& val);
    void handleF64Log(BuildContext& bc, const Value& val);
    void handleF64Sin(BuildContext& bc, const Value& val);
    void handleF64Cos(BuildContext& bc, const Value& val);
    void handleF64Abs(BuildContext& bc, const Value& val);
    void handleF64Min(BuildContext& bc, const Value& val);
    void handleF64Max(BuildContext& bc, const Value& val);
    void handleF64CopySign(BuildContext& bc, const Value& val);
    void handleF64Ceil(BuildContext& bc, const Value& val);
    void handleF64Floor(BuildContext& bc, const Value& val);
    void handleF64Trunc(BuildContext& bc, const Value& val);
    void handleF64Nearest(BuildContext& bc, const Value& val);
    void handleF64Pow(BuildContext& bc, const Value& val);
